...
<aside class="sidebar">
    ...
    ?>        
        ...
        <?php if($jogo->nota_jogo >= 9) {
            ...
            <span class="Nota" style = "color: #ffffff"> <?php echo htmlspecialchars($jogo->nota_jogo) ?></span>
            </div>
            ...
            <span class="Nota" style = "color: #fffffffe"> <?php echo htmlspecialchars($jogo->nota_jogo) ?></span>
            </div>
